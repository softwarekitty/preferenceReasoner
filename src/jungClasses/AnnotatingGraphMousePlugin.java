    ...
    public void mousePressed(MouseEvent e) {
    	...
    	if(e.isPopupTrigger()) {
    		...
    		if(annotationString != null && annotationString.length() > 0) {
    			...
    			Annotation<String,Integer> annotation =
    				new Annotation<String,Integer>(annotationString, layer, annotationColor, fill, p,null);
    ...
    public void mouseReleased(MouseEvent e) {
    	...
    	if(e.isPopupTrigger()) {
        	...
        	if(down != null) {
        		...
        		Annotation<Shape,Integer> annotation =
        			new Annotation<Shape,Integer>(s, layer, annotationColor, fill, out,null);
        		annotationManager.add(layer, annotation);
        	}
        }
        down = null;
