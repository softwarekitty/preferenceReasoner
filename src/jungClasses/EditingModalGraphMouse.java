...
import graph.AttributeEditingPlugin;
import graph.AttributeEditingPopupPlugin;
import graph.PreferenceMousePlugin;
...
public class EditingModalGraphMouse<V,E> extends AbstractModalGraphMouse 
	...
	protected PreferenceMousePlugin<V,E> annotatingPlugin;
...
//		add(popupEditingPlugin);
		...
		editingPlugin = new AttributeEditingPlugin<V,E>(vertexFactory, edgeFactory);
		labelEditingPlugin = new LabelEditingGraphMousePlugin<V,E>();
		annotatingPlugin = new PreferenceMousePlugin<V,E>(rc);
		popupEditingPlugin = new AttributeEditingPopupPlugin<V,E>(vertexFactory,edgeFactory);
		add(scalingPlugin);
